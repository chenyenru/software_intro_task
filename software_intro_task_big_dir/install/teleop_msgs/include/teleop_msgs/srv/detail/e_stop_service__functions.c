...
{
  teleop_msgs__srv__EStopService_Request * msg = (teleop_msgs__srv__EStopService_Request *)malloc(sizeof(teleop_msgs__srv__EStopService_Request));
  if (!msg) {
    return NULL;
  }
...
teleop_msgs__srv__EStopService_Request__Sequence__init(teleop_msgs__srv__EStopService_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (teleop_msgs__srv__EStopService_Request *)calloc(size, sizeof(teleop_msgs__srv__EStopService_Request));
    if (!data) {
      return false;
    }
...
{
  teleop_msgs__srv__EStopService_Request__Sequence * array = (teleop_msgs__srv__EStopService_Request__Sequence *)malloc(sizeof(teleop_msgs__srv__EStopService_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  teleop_msgs__srv__EStopService_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    teleop_msgs__srv__EStopService_Request * data =
      (teleop_msgs__srv__EStopService_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!teleop_msgs__srv__EStopService_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          teleop_msgs__srv__EStopService_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  teleop_msgs__srv__EStopService_Response * msg = (teleop_msgs__srv__EStopService_Response *)malloc(sizeof(teleop_msgs__srv__EStopService_Response));
  if (!msg) {
    return NULL;
  }
...
teleop_msgs__srv__EStopService_Response__Sequence__init(teleop_msgs__srv__EStopService_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (teleop_msgs__srv__EStopService_Response *)calloc(size, sizeof(teleop_msgs__srv__EStopService_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  teleop_msgs__srv__EStopService_Response__Sequence * array = (teleop_msgs__srv__EStopService_Response__Sequence *)malloc(sizeof(teleop_msgs__srv__EStopService_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  teleop_msgs__srv__EStopService_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    teleop_msgs__srv__EStopService_Response * data =
      (teleop_msgs__srv__EStopService_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!teleop_msgs__srv__EStopService_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          teleop_msgs__srv__EStopService_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
