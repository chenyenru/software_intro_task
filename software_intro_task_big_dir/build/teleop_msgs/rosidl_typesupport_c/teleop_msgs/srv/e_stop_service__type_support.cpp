...
static const _EStopService_Request_type_support_symbol_names_t _EStopService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, teleop_msgs, srv, EStopService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, teleop_msgs, srv, EStopService_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, teleop_msgs, srv, EStopService_Request)() {
  return &::teleop_msgs::srv::rosidl_typesupport_c::EStopService_Request_message_type_support_handle;
}
...
static const _EStopService_Response_type_support_symbol_names_t _EStopService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, teleop_msgs, srv, EStopService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, teleop_msgs, srv, EStopService_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, teleop_msgs, srv, EStopService_Response)() {
  return &::teleop_msgs::srv::rosidl_typesupport_c::EStopService_Response_message_type_support_handle;
}
...
static const _EStopService_type_support_symbol_names_t _EStopService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, teleop_msgs, srv, EStopService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, teleop_msgs, srv, EStopService)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, teleop_msgs, srv, EStopService)() {
  return &::teleop_msgs::srv::rosidl_typesupport_c::EStopService_service_type_support_handle;
}
