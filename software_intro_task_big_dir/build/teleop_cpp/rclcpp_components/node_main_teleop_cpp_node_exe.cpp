...
#define NODE_MAIN_LOGGER_NAME "teleop_cpp_node_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libteleop_cpp_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<triton_ai::teleop_cpp::TeleopCppNode>";
